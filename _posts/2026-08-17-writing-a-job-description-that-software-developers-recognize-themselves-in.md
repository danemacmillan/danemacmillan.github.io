...
- The best kind of code to maintain is the code that does not exist: simply stated, seeking the approach that minimizes complexity, promotes eloquence, and does not sacrifice maintainability is paramount. Deleting code is therapeutic.
- Experience to weigh the benefits of one technology over another. Advocate reservation in the face of emerging trends.
